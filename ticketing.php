                        	...
                        	<fieldset>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:30px;">
                					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       <span><input type="radio" name="trip" value="Oneway" onclick="hidedatecombo()"<?php if(isset($_POST['way_type'])){echo ''.$valueOneWay; } ?> class="radio_btn">One Way</span>
                                    </div>
                                    
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                         <span>&nbsp;</span>
                                         <br>
                                     	 <span><input id="ch_in" type="text" class="form-control1 textbd" name="check_in" placeholder="Departure Date" <?php if(isset($_POST['checkin'])){echo 'value='.$checkin; } ?>> </span>  
                             		</div>
                <!--
                               		<div id="returnpanel" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                               			<span>&nbsp;</span>
                               			<br>
                             			<span><input id="ch_out" type="text" class="form-control1 textbd" name="check_out" placeholder="Return Date" <?php if(isset($_POST['checkout'])){echo 'value='.$checkout; }  ?>> </span>  
                             		</div>
                                 -->
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           				<span>&nbsp;</span>
                           				<br>
                           				<span><input type="text" class="form-control textbd" id="from" name="from_" <?php if(isset($_POST['from'])){echo 'value='.$from; } ?> placeholder="From"></span>
                           			</div>
                           			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           				<span>&nbsp;</span>
                           				<br>
                           				<span><input type="text" class="form-control textbd" id="from" name="to_" <?php if(isset($_POST['to'])){echo 'value='.$to; } ?> placeholder="To"></span>
                                	</div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6" style="margin-top:20px;">
                                            ...
                                            <span>
                                                <select class="form_con2" name="adult_">
                                                    <?php if(isset($_POST['adult'])){echo '<option>'.$adult.'</option>';} else{ echo '<option>1</option>';} ?>
                                    ...
                                    <?php if(isset($_POST['service'])){echo '<option>'.$stype.'</option>';} else{ echo '<option>Class</option>';} ?>
                            ...
                            <br>-->
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:15px; margin-left:20px;"> 
                                	<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                             			<input type="checkbox" id="checbox1" name="subject1_" value="Dates Flexible" <?php if(isset($_POST['subject1'])){echo ''.$checkdates; } ?> /><span style="font-size:13px; font-weight:bold;">  I want the lowest fare my dates are flexible (+/- 3 days)</span>
              				 		</div>
