			...
			<div class="container">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="sri_lanka.php">Sri Lanka</a></li>
						<li><a href="package.php">Packages</a></li>
						<li><a href="outbound.php">Outbound Tours</a></li>
                        <li><a href="careers.php">carees</a></li>
       ...
       <!-- <div class="slider_bottom">
        	<div class="container">
                <div class="row">
                    ...
                    <h2> A Provider of Total Destination Management Services in Sri Lanka</h2>
                   <p>Rameca Travel & Leisure Club (Pvt) Ltd</p>
   	...
   	<div class="row">
    	<div class="col-lg-12 col-md-12 col-sm-12">
        	<div class="col-lg-8 col-md-8 col-sm-8">
            	<!--<div class="main_top">
                	<h4>Vision</h4>
                    <p class="para">Vcreations™ is a sub-Department of Vertec International which is subsidiary of “VERTEC GROUP” started on 1990 and “Vertec” founder-Chairman was Mr. M.P.T .Cooray, former Deputy Director General of BOI .We have been working as service providers for international outsource companies for the last eight years.</p>
                </div>--> 
               <!-- <div class="mission">
                	<h4>Mission</h4>
                    
                    <p class="para">Vcreations™ is a sub-Department of Vertec International which is subsidiary of “VERTEC GROUP” started on 1990 and “Vertec” founder-Chairman was Mr. M.P.T .Cooray, former Deputy Director General of BOI . We have been working as service providers for international outsource companies for the last eight years. Our target is to “provide a website for all in the community.”</p>
                </div>--> 
                <div class="about_com">
                <br>
                	<h4>TravaLine</h4>
               ...
               <div class="col-lg-12" style="background-color: #0099ff;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6" style="margin-bottom:30px;">
                	<img src="image/about_img2.jpg" style="width:95%;"/>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6" style="margin-bottom:30px;">
                	<img src="image/about_img3.jpg" style="width:95%;"/>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6" style="margin-bottom:30px;">
                	<img src="image/about_img4.jpg" style="width:95%;"/>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                	<img src="image/about_img5.jpg" style="width:95%;"/>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                	<img src="image/about_img6.jpg" style="width:95%;"/>
                </div>-->
            </div>
...
<!--           <div class="controls pull-right hidden-xs" style="margin-bottom: -10px;">
